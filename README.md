...
- Разработать простые модели на основе данных;

## Требования нашего курса:

- Реализовать 1 индивидуальный проект: код опубликовать в github, продемонстрировать работу кода. Презентация на 5-8 минут о проекте и результатах работы;
...
- Небольшое индивидуальное собеседование.

# Формат занятий:
- Созвоны раз в 2 недели (?) -- посещение не обязательно. Других занятий не будет - только самостоятельная работа. 
...
|2026|Сделаем простого бота для проверки лаб. работ (LLM) <br/>  пример линейной регрессии <br/>| Задача: улучшить работу бота. Протестировать работу бота для 3х других бесплатных моделей. Поменять промт, поменять параметры модели. Выбрать лучшую конфигурацию. (см. функцию check_with_ai в 2_simple_bot/bot.py, 2_simple_bot/README.md). В свой репозиторий выложить лучшую конфигурацию и небольшой файл с экспериментами (в свободной форме, оценка работы модели субъективна) 
|2026|задачи ML, регрессия для задачи предсказания цены бриллиантов| [домашка по ссылка](https://www.kaggle.com/competitions/linear-regression-apu/overview), дедлайн 24.10.2025|
|2026|классификация| [домашка по ссылка](https://github.com/IImbryk/ml_2024/blob/main/4_classification/homework.md), дедлайн 7.11.2025|
|2026| Метрики качества и алгоритмы дерева решений |[домашка по ссылка](https://github.com/IImbryk/ml_2024/blob/main/6_trees/homework.md), дедлайн 21.11.2025|
|2026| Streamlit (простой веб-интерфейс для модели)|прикрепить ссылку на гит с наработками по проекту|
